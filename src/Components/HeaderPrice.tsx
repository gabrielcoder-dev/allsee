...
export default function HeaderPrice() {
  ...
  return (
    <div
      id="header-price"
      className="fixed bottom-0 left-0 right-0 z-30 flex items-center justify-between w-full border-t border-solid border-neutral-high-light bg-white py-4 px-4 lg:px-[80px]"
    >
